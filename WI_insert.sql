...
("¿Cómo se denomina al ATP cuando perdió un fosfato por hidrólosis?","Adenosindifosfato - ADP","Adenosintrifosfatodesfosforizado - ATPD","Trinitrotolueno","Desfosfiadenosin DAS",3,5,3,5),
("¿Qué enzimas ayudan al proceso de fosforilación?","Quinasas","Fosfatasas","Fosfitasas","ATPasas",3,5,3,5),
("¿Qué genera una molécula de glucosa a través de la glucólisis?","2 piruvatos y 2 ATP","6 moléculas de CO2, 6 de agua y energía","Energía pura","Lactatos",3,5,3,5),
("¿En qué se divide la etapa de respiración en la oxidación de la glucosa?","Ciclo de Krebs y transporte de electrones","Glucólisis y fermentación","Ciclo de Krebs y formación de fosfatos","Glucólisis y Oxidación láctica",3,5,3,5),
("¿En qué se puede transformar el piruvato en presencia de oxígeno?","Dióxido de carbono","Hidrógeno","Peróxido de hidrógeno","Monóxido de carbono",3,5,3,5),
("¿Qué tipos de fermentación existen?","Alcohólica y láctica","Fermento levadúrico (de la levadura)","Aerobio y anaerobia","Ninguna de las anteriores",3,5,3,5),
("¿Qué ayuda a transportar los electrones tras la separación de hidrógenos de la cadena carbonatada de la glucosa?","Coenzimas como el NAD+ o FAD","Enzimas como la transportasa","El citoesqueleto que ayuda al transporte dentro de las moléculas","Elementos conductores de energía como metales",4,5,3,5),
("¿Que realiza NAD+ y FAD tras captar electrones y ser reducidos?","Entregan los electrones a moléculas con menor potencial de reducción, cediéndolos a la cadena respiratoria","Se desintegran a moléculas básicas para ser reformados","Salen de la célula para ser recibidos en otra","Transportan la energía por el organismo a los órganos que la necesitan",4,5,3,5),
("¿Cómo se llama la enzima que ayuda a la hidrolización el ATP?","ATPasa","Quinasa","Hidrasa","Lizasa",4,5,3,5),
("¿Cuál es un ejemplo del uso de la energía en células?","Transporte de moleculas en membranas celulares en contra gradiente","Generación de alimento","Producción lumínica","Sustitución de materia necesaria con consumo energético",4,5,3,5),
("¿Qué tipo de enlace une a los fosfatos del ATP?","Covalente","Iónico","Fosforilado","Energizado",4,5,3,5),
("¿Qué enzima ayuda a eliminar los grupos fosfatos añadidos en la forforilación?","Fosfatasas","ATPasas","Quinasas","Reductasa",4,5,3,5),
("¿Qué moléculas genera una glucosa con 6 moléculas de oxígeno?","6 moléculas de CO2, 6 de agua y energía","6 moléculas de monóxido de carbono, 3 de ozono y energía","El oxígeno maximiza el uso de la glucosa obteniendo sólo energía","12 moléculas de agua y 3 de monóxido de carbono",4,5,3,5),
("¿Qué forma el ácido pirúvico antes de entrar al Ciclo de Krebs?","Acetil-CoA","2 piruvatos","1 piruvato","3 piruvatos",4,5,3,5),
("¿Cuántas moléculas de NADH se producen en la fosforilación oxidativa?","10","12","8","6",4,5,3,5),
("¿Cuántas moléculas de FADH2 se producen en la fosforilación oxidativa?","2","4","6","8",4,5,3,5),
("¿Cuántas moléculas de ATP produce una molécula de NADH?","2.5","2","1.5","1",4,5,3,5),
("¿Cuántas moléculas de ATP produce una molécula de FADH2?","1.5","1","2","2.5",4,5,3,5),
